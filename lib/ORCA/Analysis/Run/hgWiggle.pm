...
ORCA::Analysis::Run::hgWiggle - Wrapper for Jim Kent source tree
...
package ORCA::Analysis::Run::hgWiggle;
...
=head2
 ...
 Title    : new
 Usage    : $hgw = ORCA::Analysis::Run::hgWiggle->new();
 Function : Create a new ORCA::Analysis::Run::hgWiggle object.
 Returns  : An ORCA::Analysis::Run::hgWiggle object.
 Args	  : None
