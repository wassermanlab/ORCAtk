...
# Libs
use constant ORCA_LIB		        => '/space1/home/dave/devel/ORCAtk/lib';
#
...
# phastCons DB
#
#use constant ENSEMBL_LIB	        =>
#    '/usr/local/src/ensembl-current/ensembl/modules';
#use constant ENSEMBL_COMPARA_LIB	=>
#    '/usr/local/src/ensembl-current/ensembl-compara/modules';
use constant ENSEMBL_LIB	        =>
    '/usr/local/src/ensembl-59/ensembl/modules';
use constant ENSEMBL_COMPARA_LIB	=>
    '/usr/local/src/ensembl-59/ensembl-compara/modules';
...
use constant ABS_LOG_PATH	    => '/space/devel/ORCAtk/log';
...
use constant MIN_TFBS_CONSERVATION_OVERLAP
                                    => 1;
