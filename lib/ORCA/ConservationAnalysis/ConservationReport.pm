...
ORCA::ConservationAnalysis::ConservationReport - Object to hold the results
of a conservation analysis (currently only generated by
ORCA::ConservationAnalysis::Run::AlignCons).
...
package ORCA::ConservationAnalysis::ConservationReport;
...
=head2
 ...
 Title    : new
 Usage    : my $report = ORCA::ConservationAnalysis::ConservationReport->new(
				-report_type		=> 'c'),
				-conserved_regions	=> $regions,
				-filtered_features	=> $features,
				-alignment		=> $align);
 Function : Create a new ORCA::ConservationAnalysis::ConservationReport object.
 Returns  : A ORCA::ConservationAnalysis::ConservationReport object.
 Args     : report_type which must be either 'c' for a conserved regions
	    ...
	    ORCA::ConservationAnalysis::ConservedRegion objects. For report
...
=head2
 ...
 Returns  : A reference to a list of
 	    ORCA::ConservationAnalysis::ConservedRegion objects.
 Args     : None.
